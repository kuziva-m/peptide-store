...
serve(async (req: Request) => {
  ...
  try {
    ...
    // ========================================================================
    // SCENARIO A: GENERIC EMAIL (From Admin Email Center)
    // ========================================================================
    if (payload.html && payload.to) {
      // The Admin Panel constructs the HTML, so we just pass it through.
    ...
    // ========================================================================
      ...
      // Destructure expected transactional fields
      const {
        email,
        name,
        orderId,
