  ...
  const handleLogin = async (loginCode = code, loginPin = pin) => {
    ...
    try {
      ...
      const { data: ordersData, error: ordersError } = await supabase
        .from("orders")
        .select("created_at, customer_name, total_price, items")
        .ilike("discount_code", loginCode.trim())
        ...
        >
          ...
          >
            ...
            <div style={styles.metricCard}>
              ...
              <p style={styles.metricDesc}>Total orders using your code</p>
            </div>
            ...
            <div style={styles.metricCard}>
              ...
              <p style={styles.metricDesc}>Total revenue generated for store</p>
            </div>
          </div>
